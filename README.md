...
RPS使用全库最新日期且有至少121根日线的本地股票池计算。
日期落后的股票明确标记；排序用于安排查看，不代表收益预测，多策略命中也不等于独立证据。
...
| **LimitUpShakeout** | 昨日涨幅至少9.5%，今日放量收阴但低点守住昨收；不能证明洗盘 |
| **UptrendLimitDown** | 昨日MA20高于MA60，今日跌幅至少9.5%且放量；尚未验证反包 |
